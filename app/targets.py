...
BUILTIN_TARGETS: tuple[TargetSpec, ...] = (
    ...
    TargetSpec(
        ...
        expected_url="https://evidenceflow-harness.onrender.com",
        health_path="/health",
        mode="live_smoke",
        adapter="generic_http",
        evaluation_pack="rag",
        run_path="/harness/smoke",
    ...
    TargetSpec(
        ...
        expected_url="https://quotesense-harness.onrender.com",
        health_path="/health",
        mode="live_smoke",
        adapter="generic_http",
    ...
    TargetSpec(
        ...
        expected_url="https://webqa-harness.onrender.com",
        health_path="/health",
        mode="live_smoke",
        adapter="generic_http",
